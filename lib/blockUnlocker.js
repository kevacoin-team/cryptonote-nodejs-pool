...
// This limit the number of parallel requests to the daemon.
// Without this limit, we will sometimes get the error message
// "Work queue depth exceeded" on Kevacoin daemon.
const MAX_PARALLEL_RPC_REQUESTS = 15;
...
function runInterval () {
	async.waterfall([
		...
		function (blocks, callback) {
			async.filterLimit(blocks, MAX_PARALLEL_RPC_REQUESTS, function (block, mapCback) {
